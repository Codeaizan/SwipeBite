  ...
  return (
    <div className="fixed inset-0 z-[200] bg-[#0f0f0f] flex flex-col items-center justify-center p-8 text-center">
      ...
      >
        ...
        <p className="text-[#888] text-lg mb-12 max-w-[280px]">
          Discover trending food at LPU kiosks. Sign in to start swiping!
        </p>

        <Button
          onClick={handleSignIn}
          className="w-full max-w-xs bg-white text-black hover:bg-white/90 font-bold py-7 text-lg rounded-2xl flex items-center justify-center gap-3 shadow-xl"
        >
